...
# Category        : attacks
#
# Last Update     : 2025-04-02 01:46:32
# Blacklist       : DSHIELD
#
# ABOUT CONTACT:
# HybridNetworks Ltd.
...
add list=HN-BLACKLIST-DSHIELD comment=DSHIELD address=103.23.244.0/24
...
add list=HN-BLACKLIST-DSHIELD comment=DSHIELD address=45.82.78.0/24
add list=HN-BLACKLIST-DSHIELD comment=DSHIELD address=193.163.125.0/24
add list=HN-BLACKLIST-DSHIELD comment=DSHIELD address=45.9.120.0/24
