...
# Category        : attacks
#
# Last Update     : 2022-04-25 01:43:54
# Blacklist       : DSHIELD
#
# ABOUT CONTACT:
# HybridNetworks Ltd.
...
add list=HN-BLACKLIST-DSHIELD comment=DSHIELD address=170.106.115.0/24
add list=HN-BLACKLIST-DSHIELD comment=DSHIELD address=141.98.10.0/24
add list=HN-BLACKLIST-DSHIELD comment=DSHIELD address=37.0.11.0/24
